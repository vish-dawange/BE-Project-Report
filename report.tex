...
\fancyfoot[L]{\emph{This project proposes a GCC Extension for Detecting Critical Sections in a Multi-threaded Environment.}} % except the center
\fancyfoot[R]{\thepage}
...
\fancyfoot[LO,LE]{\emph{This project proposes a GCC Extension for Detecting Critical Sections in a Multi-threaded Environment.}}
\cfoot{}
...
\addtocontents{lof}{\protect\thispagestyle{empty}}
\listoftables % adds List of Figures
\cleardoublepage
